...
| Product Detail | DONE | Product detail, personalized match section, v1.15 decision-support safety wording, and v1.27 save-decision polish. |
...
| Saved Products | DONE | Save/unsave flow with v1.27 save-context and empty-state clarity polish. |
...
| Local validation evidence | MIXED BY MILESTONE | v1.27 scoped validation passed with lint, typecheck, and unit tests. v1.26, v1.25.1, and v1.25 scoped validation passed previously. v1.24 closeout remains NOT DONE because build and E2E timed out in the current environment. |
