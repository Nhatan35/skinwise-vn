...
```txt
Continue only with the next explicitly scoped task after TASK AI-005 review. Do not begin AI-006, Ingredient Explanation, Product submission, admin product management, Journal, skin score, image upload, or medical diagnosis without a new task.
```
