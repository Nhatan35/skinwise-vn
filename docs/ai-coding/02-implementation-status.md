...
```txt
TASK RL-002 — RoutineLog UI integration, or another explicitly scoped next task. Do not begin Product submission, admin product management, Ingredient explanation AI API, real AI provider integration, Journal, dashboard data integration, skin score, image upload, or medical diagnosis without a new task.
```
