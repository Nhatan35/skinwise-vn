...
```txt
TASK AI-002 — Structured Output Validation. Do not begin Ingredient Explanation, Product submission, admin product management, Journal, skin score, image upload, or medical diagnosis without a new task.
```
