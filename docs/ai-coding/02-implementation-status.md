...
```txt
TASK DB-001 — Dashboard Data Integration, or another explicitly scoped next task. Do not begin Product submission, admin product management, Ingredient explanation AI API, real AI provider integration, Journal, skin score, image upload, or medical diagnosis without a new task.
```
