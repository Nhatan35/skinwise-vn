...
describe("auth proxy foundation", () => {
  it("matches protected dashboard, onboarding, Skin Profile, Routines, Routine Logs, Journal, Products, Product Match, Saved Products, Insights, Ingredients, and Settings routes", () => {
