...
import { listRoutineAnalysesForCurrentUser } from "@/modules/ai-analysis/analyze-routine.use-case";
import type { RoutineAnalysisHistoryDto } from "@/modules/ai-analysis/routine-analysis.dto";
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    return jsonResponse<RoutineAnalysisHistoryDto>(history);
  } catch {
